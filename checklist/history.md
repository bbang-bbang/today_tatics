...
- 2026-05-12 10:11:31 | git push origin main 2>&1 | tail -5 && echo '---PUSH DONE---' && ssh -i today-project.pem -o StrictHostKeyChecking=no -o IdentitiesOnly=yes -o ConnectTimeout=15 rocky@1.201.126.200 "cd /opt/today_tactics && git pull -q && git log -1 --oneline && sudo systemctl restart today_tactics && sleep 2 && sudo systemctl is-active today_tactics" 2>&1 | grep -v "post-quantum\|store now\|openssh.com"
...
- 2026-05-12 13:30:53 | scp -i today-project.pem -o StrictHostKeyChecking=no -o IdentitiesOnly=yes rocky@1.201.126.200:/opt/today_tactics/players.db players.db.from_prod 2>&1 | tail -3 && ls -la players.db.from_prod 2>&1
